...
CREATE TABLE tests (
    ...
    coverage_mode VARCHAR(20) NOT NULL DEFAULT 'BALANCED_PER_DOC_CHUNKS',
    ...
    CONSTRAINT chk_tests_generation_lifecycle CHECK (
        (generation_started_at IS NULL OR created_at <= generation_started_at)
        AND (generation_finished_at IS NULL OR generation_started_at IS NULL OR generation_started_at <= generation_finished_at)
